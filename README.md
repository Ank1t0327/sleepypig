...
This repo also contains a simple Node/Express backend for the prediction game in `server/`.
...
```sh
MONGO_URI="mongodb://127.0.0.1:27017/sleepypig"
PORT=8080
# Comma-separated allowed origins (recommended for Vercel), e.g.
